                    ...
                    <div class="sidebar-widget about-agent-widget">
                        ...
                        <div class="widget-content">
                            <div class="info-box">
                                ...
                                <span class="designation"><?=$arResult['PROPERTIES']['SALES_AGENT_CATEGORY']['VALUE']?></span>
                                ...
                                <ul class="contact-info">
                                    <li><strong>Тел:</strong><a href="tel:<?=$arResult['PROPERTIES']['SALES_AGENT__PHONE']['VALUE']?>"><?=$arResult['PROPERTIES']['SALES_AGENT__PHONE']['VALUE']?></a></li>
                                    <li><strong>Email:</strong><a href="mailto:<?=$arResult['PROPERTIES']['SALES_AGENT__EMAIL']['VALUE']?>"><?=$arResult['PROPERTIES']['SALES_AGENT__EMAIL']['VALUE']?></a></li>
                                </ul>
                                <div class="btn-box">
