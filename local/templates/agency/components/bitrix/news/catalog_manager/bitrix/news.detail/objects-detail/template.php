                    ...
                    <div class="row">
                        <div class="about-property col-lg-7 col-md-12 col-sm-12">
                            ...
                            <ul class="property-info clearfix">
                                ...
                                <li><i class="fa fa-bed"></i> Комнат <?=$arResult["PROPERTIES"]["ROOMS"]["VALUE"]?></li>
                            </ul>
                        </div>
                                    ...
                                    <div class="inner-box">
                                        ...
                                        <div class="lower-content">
                                            <ul class="property-info clearfix">
                                                ...
                                                <li><span class="icon fa fa-bed"></span> Комнат <?=$elem['PROPERTIES']['ROOMS']['VALUE']?></li>
                ...
                <aside class="sidebar default-sidebar">
                    ...
                    <div class="sidebar-widget about-agent-widget">
                        ...
                        <div class="widget-content">
                            <div class="info-box">
                                <h3 class="name"><?=$arResult['PROPERTIES']['SALES_AGENT__NAME']['VALUE']?></h3>
                                <?if($arResult['PROPERTIES']['SALES_AGENT__CATEGORY']['VALUE']) {?>
                                    <span class="designation"><?=$arResult['PROPERTIES']['SALES_AGENT__CATEGORY']['VALUE']?></span>
                                <?} else {?>
                                ...
                                <? $APPLICATION->IncludeComponent(
                                    ...
                                    Array(
                                        ...
                                        "CACHE_TIME" => "36000000",
                                        "CACHE_GROUPS" => "Y",
                                        "SALES_AGENT__PHONE" => $arResult['PROPERTIES']['SALES_AGENT__PHONE']['VALUE'],
                                        "SALES_AGENT__EMAIL" => $arResult['PROPERTIES']['SALES_AGENT__EMAIL']['VALUE'],
                                        "SALES_AGENT__CATEGORY" => $arResult['PROPERTIES']['SALES_AGENT__CATEGORY']['VALUE']
                                    )
                                );
                                ?>
                                <ul class="contact-info">
                                    <li class="phone"><strong>Тел:</strong><a href="tel:<?=$arResult['PROPERTIES']['SALES_AGENT__PHONE']['VALUE']?>"><?=$arResult['PROPERTIES']['SALES_AGENT__PHONE']['VALUE']?></a></li>
                                    <li class="email"><strong>Email:</strong><a href="mailto:<?=$arResult['PROPERTIES']['SALES_AGENT__EMAIL']['VALUE']?>"><?=$arResult['PROPERTIES']['SALES_AGENT__EMAIL']['VALUE']?></a></li>
